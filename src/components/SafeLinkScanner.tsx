...
export default function SafeLinkScanner() {
  ...
  const COLORS = result
    ? [result.isSafe ? "#22c55e" : "#ef4444", "#f1f5f9"]
    : [];
              ...
              <div className="w-48 h-48 relative flex-shrink-0">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <span
                    className={cn(
                      "text-4xl font-bold",
                      result.isSafe ? "text-blue-500" : "text-red-500",
                    )}
                  >
                    {result.score}
                  </span>
                  ...
                  {result.publicData && (
                    <div className="bg-white rounded-xl p-5 border border-slate-200 shadow-sm">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {Object.entries(result.publicData).map(
                          ([key, value]) => {
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-slate-600 text-sm mt-1">
                Copy the website link or URL you want to investigate.
              </p>
            </div>
          </div>
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-slate-600 text-sm mt-1">
                Paste the link into the box above and click 'Scan URL'.
              </p>
            </div>
          </div>
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-slate-600 text-sm mt-1">
                Our AI gives it a safety score out of 100. A score of 100 means
                completely safe. A red graph means the website might be
                dangerous or a phishing scam. Read the detailed explanation
                below the score to understand why.
              </p>
            </div>
          </div>
        </div>
