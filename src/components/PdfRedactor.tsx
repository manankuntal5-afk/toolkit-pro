...
export default function PdfRedactor() {
  ...
  const processFile = async () => {
    ...
    try {
      ...
      if (res.ok && data.content) {
        ...
        setErrorMsg(
          data.error || "Failed to redact document. Please try again.",
        );
        setStep(3);
      }
    } catch (err: any) {
  ...
  return (
    <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-center mb-8 pb-8 border-b border-slate-100">
          <div className="flex items-center">
            ...
            <div
              className={cn(
                "w-12 h-1 transition-colors",
                step >= 3 ? "bg-blue-600" : "bg-slate-100",
              )}
            ></div>
            <div
              className={cn(
            ...
            <div
              className={cn(
                "w-12 h-1 transition-colors",
                step >= 4 ? "bg-blue-600" : "bg-slate-100",
              )}
            ></div>
            <div
              className={cn(
        ...
        <div className="max-w-xl mx-auto">
          ...
          {step === 2 && (
            <div className="space-y-6 animate-in slide-in-from-right-8 duration-300">
              ...
              <p className="text-center text-slate-500 mb-8">
                What do you want to do with the text "{word}"?
              </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  <div className="text-3xl filter blur-[4px] group-hover:blur-[6px] transition-all overflow-hidden relative">
                    ...
                    <span className="absolute inset-0 bg-slate-300 rounded overflow-hidden flex items-center justify-center text-transparent">
                      BLUR
                    </span>
                  </div>
              ...
              <button
                onClick={() => setStep(1)}
                className="text-blue-600 text-sm font-medium hover:underline w-full text-center mt-4"
              >
                Back
              </button>
            </div>
          ...
          {step === 3 && (
            <div className="space-y-6 animate-in slide-in-from-right-8 duration-300">
              ...
              <p className="text-center text-slate-500 mb-8">
                Where do you want to {actionType === "blur" ? "blur" : "hide"}{" "}
                the text "{word}"?
              </p>
              ...
              <div className="flex flex-col gap-4">
                ...
                >
                  ...
                  <p className="text-slate-500 text-sm">
                    Only {actionType === "blur" ? "blur" : "hide"} the very
                    first time this word or number appears in the file.
                  </p>
                </button>
                <button
                  onClick={() => {
                ...
                >
                  ...
                  <p className="text-slate-500 text-sm">
                    Find and {actionType === "blur" ? "blur" : "hide"} every
                    instance of this word throughout the file.
                  </p>
                </button>
              </div>
              <button
            ...
            <div className="space-y-6 text-center animate-in zoom-in-95 duration-300 py-8">
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-slate-500">
                  Searching for '{word}', applying {actionType} to{" "}
                  {scope === "all" ? "all instances" : "first instance"}. This
                  might take a minute.
                </p>
              </div>
            </div>
      ...
      {step === 5 && resultHtml && (
        <div
          className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 animate-in fade-in duration-500 mb-12"
          id="redacted-doc"
        >
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-xl font-bold text-slate-800 flex items-center gap-2">
              <Eye className="w-5 h-5 text-blue-600" /> Preview Redacted
              Document
            </h3>
            <button
              onClick={reset}
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
        ...
        <div className="space-y-6">
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-slate-600 text-sm mt-1">
                Select document language, upload your PDF file and type the
                exact text or number you want to hide (e.g. your account number
                or name).
              </p>
            </div>
          </div>
          <div className="flex gap-4">
            ...
            <div>
              <h4 className="font-semibold text-slate-900">
                Choose Action (Hide/Blur)
              </h4>
              <p className="text-slate-600 text-sm mt-1">
                Choose whether you want to cover the word with a black box or
                just blur it out.
              </p>
            </div>
          </div>
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-slate-600 text-sm mt-1">
                Decide if you want to apply the redaction everywhere in the file
                or just the first time it appears. Preview the result and
                download!
              </p>
            </div>
          </div>
